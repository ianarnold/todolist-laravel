...
<div class="container m-5 p-2 rounded mx-auto bg-light shadow">
    ...
    <div class="row m-1 p-3">
        <div class="col col-11 mx-auto">
            ...
            @csrf
                <div class="col">
                    <input class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded" type="text" name="name" placeholder="Nome da tarefa: ">
                    <br>
                    <input class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded" type="text" name="description" placeholder="Descrição da tarefa: ">
                </div>
        ...
        <div class="col mx-auto">
            ...
            <div class="row px-3 align-items-center todo-item rounded">
                <div class="col px-1 m-1 d-flex align-items-center">
                    <p class="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3">{{ $task->name }}</p>
                    <p class="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3">{{ $task->description }}</p>
                </div>
